                ...
                <div className='container_body'>
                    ...
                    <div className='four'>
                        <div className='inner_left'>
                            ...
                            <div>
                                <p className='pa_name'>Partrick Abrams</p>
                                <p className='pa_name1'> Verified Graduate</p>
                            </div>
                        </div>
                        <h1 className='pa_header'>  Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and
                            learning from their experiences was easy.
                        </h1>
                        <p  className='pa_paragraph'>      “ The staff seem genuinely concerned about my progress which I find really refreshing. The program
